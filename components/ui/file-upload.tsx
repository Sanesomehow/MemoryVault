  ...
  return (
    <div className="w-full" {...getRootProps()}>
      <motion.div
        ...
        whileHover="animate"
        className="p-10 group/file block rounded-lg cursor-pointer w-full relative overflow-hidden focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
        tabIndex={0}
        role="button"
      ...
      >
        <input
          ...
          type="file"
          accept="image/png,image/jpeg,image/jpg,image/heic,image/gif,image/webp"
            ...
            {files.length > 0 &&
              files.map((file, idx) => (
                <motion.div
                  ...
                  className={cn(
                    "relative overflow-hidden z-40 bg-white  flex flex-col items-start justify-start md:h-24 p-4 mt-4 w-full mx-auto rounded-md group",
                    "shadow-sm"
                  )}
                >
          ...
          return (
            <div
              ...
              className={`w-10 h-10 flex flex-shrink-0 rounded-[2px] ${
                index % 2 === 0
                  ? "bg-gray-50 "
                  : "bg-gray-50  shadow-[0px_0px_0px_1px_rgba(0,0,0,0.07)]"
              }`}
            />
          );
        })
